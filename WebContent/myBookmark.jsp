						...
						<div class="portfolio-simple">
							...
							<div class="pfInfo">
								<div class="simple-content">
									...
									<div class="pfTitle">
										<a href="#" onclick="pf(<%=port.getPf_id()%>)"> <%=port.getPf_title()%></a>
									</div>
									<div class="pfBottom">
							...
							<div class="top-hover-right">
								<div class="after-hover">
									<button type="button" id="hover" class="btn btn-hover"
										onclick="location.href='/bmk?cmd=MYBOOKMARKDELETE&bm_id=<%=port.getBm_id() %>'">
