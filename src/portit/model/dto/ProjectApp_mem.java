...
public class ProjectApp_mem {   
   ...
   private String app_confirm;
	...
	public ProjectApp_mem setMem_id(String mem_id) {
		this.mem_id = mem_id;
		return this;
	}
	public ProjectApp_mem setName(String name) {
		this.name = name;
		return this;
	}
	public ProjectApp_mem setNick(String nick) {
		this.nick = nick;
		return this;
	}
	public ProjectApp_mem setApp_confirm(String app_confirm) {
