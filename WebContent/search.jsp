		...
		<section id="main-content">
					 	...
					 	<div style="border: 1px solid black">
							<h4>
								...
								<span class="label label-default">언 어</span>&nbsp;&nbsp;&nbsp;&nbsp;
									...
									<input type="button" value="c++" onclick="fnAppendItem()"/>
									<input type="button" value="c#" onclick="fnAppendItem()"/>
									<input type="button" value="jsp" onclick="fnAppendItem()"/>
									<input type="button" value="servlet" onclick="fnAppendItem()"/>
			...
			<!-- 포트폴리오 화면 -->
				...
				<!-- 네번째 포트폴리오 -->
					...
					<div align="right">
						<h4>
							<a href="port_search.html"> <span class="label label-default"text-align:"right">더 보기</span>
							</a>
						</h4>
					</div>
					<hr />
				...
				<!-- 첫 번째 member-->
					...
					<div align="right">
						<h4>
							<a href="person_search.html"> <span class="label label-default"text-align:"right">더 보기</span>
							</a>
						</h4>
					</div>
					<hr />
				...
				<!-- 두번째 프로젝트 -->
					...
					<div align="right">
						<h4>
							<a href="proj_search.html"> <span class="label label-default"text-align:"right">더 보기</span>
							</a>
						</h4>
					</div>
				</div>
