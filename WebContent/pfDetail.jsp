...
System.out.println("test-->"+dataTF);
%>
<head>
<meta charset="utf-8">
		...
		<section id="pfHeader">
			<div class="container">
				...
				<div class="actions">
					...
					<button type="button" id = "bookmarkToggle" name ="bookmarkToggle" class="btn common" onclick="location.href='/bmk?cmd=BOOKMARK&mem_id=${sessionScope.loginId}&pf_id= ${portfolio.pf_id}'">
