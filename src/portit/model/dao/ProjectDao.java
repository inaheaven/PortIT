...
//				Prodto.setProj_regenddate(((rs.getString("proj_regenddate"))));
				...
				Prodto.setProj_regdate( new SimpleDateFormat("yyyy-mm-dd").parse(rs.getString("proj_regdate")));
				Prodto.setProj_startdate( new SimpleDateFormat("yyyy-mm-dd").parse(rs.getString("proj_startDate")));
