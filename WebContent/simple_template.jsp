          			...
          			<div class="col-md-3 mb">
          				<div class="project-simple">
          					<div class="simple-content text-center">
	          					...
	          					<div class="pjTitle"><a href="">프로젝트 제목입니다...</a></div>
	          					<div class="pjInfo">
	          					...
	          					<div class="pjRegiEndDate">
	          						<span>마감일까지</span>&nbsp;&nbsp;
	          						<span class="pjDday">D&nbsp;-&nbsp;<span>3</span></span>
	          					</div>
          					</div>
          				</div>
          			</div> <!-- project-simple end -->
          			...
          			<div class="col-md-12 mb">
          				<div class="portfolio-timeline">
          					<div class="pfTlType">
          						...
          						<span class="pfTypeText">[멤버이름]님이 내 포트폴리오를 좋아합니다.</span>
          					</div>
          					<span class="pfInfo">
	          					<div>
	          						<span class="pfTitle"><a href="">포트폴리오 제목</a></span>
	          						<span class="pfLike">
	          							<span class="glyphicon glyphicon-heart"></span>
