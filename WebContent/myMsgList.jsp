		...
		<aside>
			<div id="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="sub-menu"><a href="msgList.html"> <span>Message</span>
					</a></li>
					<hr class="line" />
							...
							<div id="msgBoxOpen" class="panel-collapse collapse">
								<div class="panel-body">
									...
									<div class="pull-right">
										<button type="button" class="btn" onclick="location.href='msgDetail.html'">더보기</button>
									</div>					
								</div>
							</div> <!-- END - msgBoxOpen -->
						</div> <!-- END - msgBox -->
