	...
	<section class="wrapper site-min-height">
		...
		<div class="col-md-12 col-sm-12 col-xs-12 mt pflist">
			...
			<div class="pflist_top col-md-12 center clearfix">
				...
				<span class="pull-left sorting"> <!-- <b>정렬</b>&nbsp; &nbsp;&nbsp;&nbsp;
					...
					<button type="button" class="btn common"
						onclick="location.href='/page?page=myPfRegister'">포트폴리오
						등록하기</button>
							...
							<div class="pfInfo">
								...
								<div class="simple-content">
									...
									<div class="pfBottom">
										...
										<span class="pfmemName"><a href=""><%=portfo.getProf_nick() %></a></span>
										<span class="pfLikeCount"><span class="fa fa-heart"></span>&nbsp;&nbsp;<%=portfo.getPf_like() %></span>
							...
							<div class="top-hover-right">
								...
								<div class="after-hover">
									...
									<button type="button" class="btn btn-hover" id="hover"
										onclick="location.href='/pfList?cmd=MYPORTFOLIODELETE&pf_id=<%=portfo.getPf_id() %>'">
