		...
		<div class="col-md-12 col-sm-12 col-xs-12 mt pflist">
			...
			<div class="pflist_box clearfix">
				<c:choose>
									...
									<div class="portfolio-simple">
										...
										<div class="pfInfo">
											<div class="simple-content">
												<div class="pfTag">
													<c:forEach items="${mypf.tags}" var="tag"
														varStatus="status">
														<a href=""># ${tag}</a>&nbsp;
														</c:forEach>
												</div>
												...
												<div class="pfBottom">
													<span class="pfmemName"><a
														href="/view?type=profile&id=${mypf.pf_prof_nick}">${mypf.pf_prof_name}</a></span>
					...
					<c:otherwise>
						<p class="text-center">등록한 포트폴리오가 없습니다.</p>
					</c:otherwise>
				</c:choose>
			</div>
		</div>
