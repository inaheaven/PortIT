			...
			while (rs.next()) {
				...
				while (rs.next()) {
					if ("language".equalsIgnoreCase(rs.getString("t.tag_type"))) {
						...
						tag_language.setTag_id(rs.getInt("t.tag_id"));
						tag_language.setTag_type(rs.getString("t.tag_type"));
						tag_language.setTag_name(rs.getString("t.tag_name"));
						tags_language.add(tag_language);
					}
					if ("tool".equalsIgnoreCase(rs.getString("t.tag_type"))) {
						Tag tag_tool = new Tag();
						tag_tool.setTag_id(rs.getInt("t.tag_id"));
						tag_tool.setTag_type(rs.getString("t.tag_type"));
						tag_tool.setTag_name(rs.getString("t.tag_name"));
						tags_tool.add(tag_tool);
					}
					if ("field".equalsIgnoreCase(rs.getString("t.tag_type"))) {
						Tag tag_field = new Tag();
						tag_field.setTag_id(rs.getInt("t.tag_id"));
						tag_field.setTag_type(rs.getString("t.tag_type"));
						tag_field.setTag_name(rs.getString("t.tag_name"));
